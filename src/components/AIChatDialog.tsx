        ...
        <DialogHeader className="px-6 pt-6 pb-4 border-b border-border/30">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-lg font-display">AI Трейдинг Помощник</DialogTitle>
                <p className="text-xs text-muted-foreground">Эксперт по бинарным опционам и Forex</p>
              </div>
            </div>
            <Button
              variant="ghost"
          ...
          <div className="flex gap-2 items-end">
            <div className="flex-1 relative">
              <Textarea
                ...
                className="min-h-[60px] max-h-[200px] resize-none glass-card border-border/30 focus:border-primary/50"
                disabled={isLoading}
              />
            </div>
            <Button
