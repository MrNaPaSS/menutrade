            ...
            <div className="relative flex flex-col h-full max-h-screen overflow-hidden bg-background">
                ...
                <header className="relative px-3 sm:px-4 pt-[calc(env(safe-area-inset-top)+var(--tg-content-top,0.5rem))] pb-2 flex-shrink-0 z-20">
                    ...
                    <div className="relative -mt-1.5 flex items-center justify-center min-h-8">
                        ...
                        <span className="ml-[22px] flex items-center gap-1 min-w-0 max-w-[62%]
                                         text-[13px] text-muted-foreground">
                            {currentMode === 'teacher' ? (
                                <><GraduationCap className="w-4 h-4 flex-shrink-0" /> Обучение</>
                            ) : (
                                <><BarChart3 className="w-4 h-4 flex-shrink-0" /> Анализ рынка</>
                            )}
