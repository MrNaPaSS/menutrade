...
export const levels: LevelInfo[] = [
  {
    ...
    name: 'FREE',
    title: 'УРОВЕНЬ FREE',
    description: 'Твой старт в алгоритмическом трейдинге!',
    features: [
    ...
    forWhom: 'Для тех, кто хочет начать зарабатывать на рынке без вложений в софт.',
    advantages: [
      'Полностью бесплатно',
      'Готовые сигналы',
      'Простой старт'
  ...
  },
  {
    ...
    name: 'PRO',
    title: 'УРОВЕНЬ PRO',
    description: 'Профессиональные инструменты для серьезного заработка!',
    features: [
      'Авторский индикатор (TradingView)',
      'Торговая стратегия',
      'Всё из уровня FREE'
    ],
    forWhom: 'Для тех, кто хочет самостоятельно принимать решения с помощью проверенных инструментов.',
    advantages: [
      'Глубокая аналитика',
...
export const platformLinks = {
  ...
  weexExchange: 'https://www.weex.com/ru/register?vipCode=NMNH_MANAGERe',
