...
export const patterns: Pattern[] = [
  ...
  },
  {
    ...
    type: "графическая фигура",
    png: "/патерны/Графическая фигура Чашка с ручкой Оранжевым цветом выделен первоначальный бычи рывок красным цветом  основная фаза борьбы продавцов и покупателей.png",
    description: "Разворот вверх"
  },
  {
    id: "diamond",
