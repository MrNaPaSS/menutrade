    ...
    return (
      <div className="min-h-[100dvh] scanline pb-16">
        ...
        <div className="relative z-10">
          ...
          <motion.div
            className="sticky top-0 z-40 bg-background/80 backdrop-blur-sm pb-2 -mx-4 px-4 pt-[var(--tg-content-top)]"
            animate={{
      ...
      <div className="relative z-10">
        <main className="p-4 sm:p-5 md:p-6 pb-8 flex justify-center">
          <div className="max-w-lg lg:max-w-5xl w-full mx-auto">
            <motion.div
              className="relative flex items-center justify-center mb-4 sm:mb-6 sticky top-0 z-40 bg-background/80 backdrop-blur-sm pb-2 -mx-4 px-4 pt-[var(--tg-content-top)]"
