...
class BotConfig:
    ...
    # Telegram Bot Token (обновленный)
    BOT_TOKEN = "7365806390:AAHWzpeLeX0RtywWchY3tXvWSYInUmV-ZV8"
    ...
    AUTHORIZED_USERS: Set[int] = {
        511442168,  # Ваш ID
        # Добавьте ID других пользователей здесь
...
BotConfig._load_authorized_users()
